...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  6 09:51:35 2025
...
# Example usage
input_folder = "Maize_Dataset"  # Change this to your input folder path
output_folder = "Maize_Dataset_GLCM_Texture"  # Change this to your output folder path
